...
public class PrebuiltAppleFramework extends AbstractBuildRuleWithDeclaredAndExtraDeps
  ...
  private final PatternMatchedCollection<String> platformSubFrameworks;
  ...
  public PrebuiltAppleFramework(
      ...
      PatternMatchedCollection<String> platformSubFrameworks,
    ...
    this.platformSubFrameworks = platformSubFrameworks;
  ...
  public SourcePath getPlatformFrameworkPath(CxxPlatform cxxPlatform) {
    Path frameworkPath = out;
    Optional<String> subFramework =
      platformSubFrameworks.getMatchingValues(cxxPlatform.getFlavor().toString()).stream().findFirst();
    if (subFramework.isPresent()) {
      frameworkPath = frameworkPath.resolve(subFramework.get());
    }
    return ExplicitBuildTargetSourcePath.of(getBuildTarget(), frameworkPath);
  }
  ...
  public CxxPreprocessorInput getCxxPreprocessorInput(
    ...
    if (isPlatformSupported(cxxPlatform)) {
      ...
      builder.addFrameworks(FrameworkPath.ofSourcePath(getPlatformFrameworkPath(cxxPlatform)));
    }
    return builder.build();
  }
  ...
  private NativeLinkableInput getNativeLinkableInputUncached(NativeLinkableCacheKey key) {
    ...
    frameworkPaths.add(FrameworkPath.ofSourcePath(getPlatformFrameworkPath(cxxPlatform)));
